...
class formLogin extends Component{
    ...
    renderBtnAcessar() {      
        ...
        // Estou trocando o botão acessar por loading
            ...
            <ImageBackground style={{flex: 1, width: null}} source={require('../imgs/original.png')}>
                <View style={{ flex:1, padding:10 }}>
                    ...
                    <View style={{ flex:2 }}>
                        ...
                        />
                        <TextInput 
                            value={this.props.senha}style={{fontSize: 20, height: 45, borderColor: 'gray', borderWidth: 1}} 
                            placeholder='Senha' 
...
//Estou pegando os valores de email e  senha e criando um 
//decorar (meio que um objeto) para usar esses valores em
// qualquer lugar 
//Aula 208
